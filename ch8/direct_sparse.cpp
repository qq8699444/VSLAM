...
bool poseEstimationDirect ( const vector< Measurement >& measurements, cv::Mat* gray, Eigen::Matrix3f& K, Eigen::Isometry3d& Tcw )
{
    ...
    //std::unique_ptr<DirectBlock::LinearSolverType> linearSolver = std::make_unique<g2o::LinearSolverDense< DirectBlock::PoseMatrixType >> ();

    DirectBlock* solver_ptr = new DirectBlock ( std::unique_ptr<DirectBlock::LinearSolverType>(linearSolver ));
    //std::unique_ptr<DirectBlock>  solver_ptr = std::make_unique<DirectBlock>(linearSolver);
